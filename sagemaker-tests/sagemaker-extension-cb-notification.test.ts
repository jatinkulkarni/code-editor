...
describe('sagemaker-extension-cb-notification.diff validation', () => {
  test('constant.ts should have capacity block notification constants', () => {
    ...
    if (!content.includes("export const CB_WARNING_30MIN_HEADER = 'Capacity Block Expiring Soon'")) {
      throw new Error(`Expected CB_WARNING_30MIN_HEADER constant not found in ${filePath}`);
    }
